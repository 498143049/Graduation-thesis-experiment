...
model_dir = 'model/experiment13'
pic_dir = 'pic/experiment13'
...
def kaze_match(im1_path, im2_path):
    ...
    cv2.imwrite(os.path.join(pic_dir,"result.png"), result)
    cv2.imwrite(os.path.join(pic_dir, "matches.png"), img3)
    cv2.imwrite(os.path.join(pic_dir, "good.png"), img4)
    cv2.imwrite(os.path.join(pic_dir, "goodRanse.png"), img5)
    plt.show()
